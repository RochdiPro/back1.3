...
@Entity
@Table(name = "Bon_Livraison_Archives")
public class Bon_Livraison_Archives   {
    ...
    public Bon_Livraison_Archives()
    {}

    public Bon_Livraison_Archives(String id_Clt, String type, String etat, double total_HT_Brut, double total_Remise, double total_HT_Net, double total_Fodec, double total_Tva, double total_TTC, double total_Retenues, String description, String id_Responsable, String mode_Paiement, byte[] detail, double frais_Livraison, Date date_Creation ,Long id_Devis  ) {
        Id_Clt = id_Clt;
        Type = type;
        Etat = etat;

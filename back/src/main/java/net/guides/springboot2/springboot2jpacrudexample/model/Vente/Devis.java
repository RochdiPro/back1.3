...
public class Devis  {
    ...
    public Devis(String id_Clt, String type, String etat, double total_HT_Brut, double total_Remise, double total_HT_Net, double total_Fodec, double total_Tva, double total_TTC,   String description, String id_Responsable, String mode_Paiement, byte[] detail, double frais_Livraison ) {
        Id_Clt = id_Clt;
        Type = type;
        Etat = etat;
